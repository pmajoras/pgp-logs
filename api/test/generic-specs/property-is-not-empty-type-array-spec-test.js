...
var target = new PropertyIsNotEmptyTypeArraySpec('arrayProp', 'string', 'Test PropertyIsNotEmptyArraySpec', 100);

describe('property-is-not-empty-type-array-spec-test', function () {
  ...
  it('should not satisfy an array with numbers', function (done) {
    target.isSatisfiedBy({ arrayProp: [1, 2] })
      .then((result) => {
