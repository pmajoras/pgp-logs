...
var PropertyIsArraySpec = require('../../specification/generic-specifications/property-is-array-spec');
var target = new PropertyIsArraySpec('arrayProp', 'Test PropertyIsArraySpec', 100);

describe('property-is-array-spec-test', function () {

  before(function () {
  });

  it('should satisfy an empty array', function (done) {
